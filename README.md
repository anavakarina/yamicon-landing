...
![Десктопная версия hero секции](screenshots/desktop-hero.png)
![Десктопная версия ассортимента с фильтрацией](screenshots/eclairs-grid.png)
![Десктопная версия формы связи](screenshots/form-validation.png)
                    

![Мобильная версия меню](screenshots/mobile-menu.png)
![Мобильная версия секции ассортимента](screenshots/mobile-eclairs.png)
![Мобильная версия секции с отзывами](screenshots/mobile-reviews.png)
